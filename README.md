...
<img width="3188" height="1202" alt="frame (3)" src="https://github.com/prstephin/Green-Bytes/blob/main/Screenshot%20(27).png" />

*it shows the roasing *

<img width="3188" height="1202" alt="frame (3)" src="https://github.com/prstephin/Green-Bytes/blob/main/Screenshot%20(28).png" />
*it shows the roasing*

<img width="3188" height="1202" alt="frame (3)" src="https://github.com/prstephin/Green-Bytes/blob/main/Screenshot%20(29).png" />
*it shows the roasing*

# Diagrams
Captures screen → Extracts text → Gemini API analyses → Generates roast in Malayalam → Text-to-Speech → You cry
*Workflow: The app continuously scans your screen, reads what you’re up to, uses AI to craft a savage Malayalam roast tailored to your activity, and then delivers it out loud—guaranteed to keep you honest and entertained.*
